    ...
    return (
        <div className="bg-zinc-50">
            <div className="container py-0 text-center lg:py-0 lg:text-left lg:flex lg:justify-between ">
                <div className="lg:w-2/3 xl:py-14 lg:py-8">
                    {/* <p className="tracking-widest">OFFER FOR THE BEST INTERIOR</p> */}
                    <h3 className="py-1 text-2xl font-extrabold leading-tight text-gray-800 xl:text-5xl lg:text-4xl" style={{fontFamily: 'Montserrat, sans-serif'}}>We Provide One Stop Solutions for All Your Interior Needs.
                    </h3>
                ...
                <div className="w-full p-1">
                    <Image src="/image2/53.jpg" width={700} height={300} alt="" className="lg:absolute right-0 xl:h-[448px] xl:w-[700px] lg:h-[344px] lg:w-[500px]  lg:block" />
                </div>
                {/* <div className="w-1/2">
