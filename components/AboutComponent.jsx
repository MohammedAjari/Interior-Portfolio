            ...
            <div className="grid lg:grid-cols-2 place-items-center ">
                ...
                <div className="items-center">
                    <p className="lg:px-12 lg:pb-4 py-3 px-4" style={{ fontFamily: 'Open Sans', fontSize: 'large' }}>
                        ...
                        <br/><br/>
                        🔸Classic and aesthetic designs tend to have a timeless quality, ensuring that your rooms beauty remains relevant over the years.
                        <br/><br/>
                        🔸A colorful and aesthetically pleasing room can stimulate creativity and imagination. Its an inspiring environment for artistic pursuits.
                        <br/><br/>
                        🔸Thoughtfully designed and aesthetically pleasing rooms can foster positive energy, creating a harmonious and vibrant environment for occupants   
