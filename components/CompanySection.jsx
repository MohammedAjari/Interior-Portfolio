        ...
        <div className="py-14  bg-zinc-100">
            ...
            <div className="container flex flex-wrap items-center justify-between lg:justify-evenly  ">
                ...
                <div className="countUP">
                    <h2 style={{ fontSize: "xx-large" , fontFamily: 'Montserrat, sans-serif'}}  class=" text-center">Our Works</h2>
                    <CountUp style={{ fontSize: "xxx-large", fontWeight: "500"  }} start={0} end={55} width={128} height={128} className=" text-center text-orange-400" duration={2.5} />
                </div>
                <div className="countUP">
                    <h2 style={{ fontSize: "xx-large" , fontFamily: 'Montserrat, sans-serif' , color:"ring-orange-400"}} class=" text-center ">Happy Customers</h2>
                    <CountUp style={{ fontSize: "xxx-large", fontWeight: "500" }} start={0} end={50} width={128} height={128} className=" text-center text-orange-400" duration={2.5} />
                </div>
                <div className="countUP">
                    <h2 style={{ fontSize: "xx-large" , fontFamily: 'Montserrat, sans-serif' , color : "ring-orange-400"}} class=" text-center ">Partner Network</h2>
                    <CountUp style={{ fontSize: "xxx-large", fontWeight: "500"  }} start={0} end={15} width={128} height={128} className=" text-center text-orange-400" duration={2.5} />
                </div>
            </div>
        </div>
    );
