...
export const metadata = {
  title: {
    default: "Contact Us - Get in Touch with Shaarda Interiors Baroda",
    template: "Contact Us | Shaarda Interiors  ",
  },
  description:
    "Have questions or want to discuss your project? Contact Shaarda Interiors in Baroda. We are here to help you bring your interior design vision to life.",
  keywords: [
    "Contact Shaarda Interiors",
    "Interior Design Consultation",
    "Get in Touch",
    "Baroda Design Studio",
    "Project Discussion",
  ],
};
...
export default function Contact() {
  function Submit() {
    ...
    fetch(
      "https://script.google.com/macros/s/AKfycbzDGHu3vJHqkgiLmqKe8vG5cmpQAGe6V9RImY2U3wGv2aka1xXILXjOXWmHZeU4OeLt/exec",
      {
        method: "POST",
        body: formDatab,
      }
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-[url('/image2/22.jpg')] bg-center bg-cover h-[400px] lg:h-[600px] relative">
        ...
        <h1
          className="absolute inset-0 flex flex-col items-center justify-center text-6xl font-semibold text-center text-white lg:text-left py-10 lg:py-0 lg:text-7xl"
      ...
      <div className="container mx-auto py-10 lg:py-20">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="py-4 px-4">
            <p
              className="text-xl font-semibold text-center text-gray-800 lg:text-2xl"
              style={{ fontFamily: "Montserrat, sans-serif" }}
            >
              EMAIL US WITH EASE
            </p>
